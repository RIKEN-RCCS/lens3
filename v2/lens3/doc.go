...
// (lenticularis-admin).  Multiplexer is a proxy, Manager is a
// sentinel of backend servers, and Registrar is a Web-API to register
// buckets and access-keys by users.  Manager is a part of
// Multiplexer.  Multiplexer and Registrar are a single binary and
// work in threads.  They can be started as separate services.
// Multiplexer and Registrar share nothing but via the keyval-db.
package lens3
