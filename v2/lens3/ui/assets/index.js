...
const NO = () => false;
const isOn$1 = (key) => key.charCodeAt(0) === 111 && key.charCodeAt(1) === 110 && (key.charCodeAt(2) > 122 || key.charCodeAt(2) < 97);
...
function createRtl(i18n, options) {
  var _a;
  const rtl = ref((_a = options == null ? void 0 : options.rtl) != null ? _a : genDefaults$3());
...
function useValidation(props) {
  ...
  const validateOn = computed(() => {
    ...
    if (value === "lazy")
      value = "input lazy";
    const set2 = new Set((_b = value == null ? void 0 : value.split(" ")) != null ? _b : []);
    return {
...
const DefaultBar = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$5]]);
const _sfc_main$6 = {
  props: {
    pool_data: {
      type: Object,
...
const PoolMake = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$4]]);
const _sfc_main$5 = {
  props: {
    pool_data: {
      type: Object,
...
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("td", null, "backend-state", -1);
const _hoisted_5$1 = /* @__PURE__ */ createBaseVNode("td", null, "online?", -1);
const _hoisted_6$1 = /* @__PURE__ */ createBaseVNode("td", null, "enabled?", -1);
    ...
    useRender(() => {
      ...
      return createVNode("div", {
        ...
        default: () => {
          ...
          }, [(_b = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _b : props.header])];
        }
      }), hasAppend && createVNode("div", {
  ...
  setup(props, _ref) {
    ...
    return () => createVNode("div", {
      ...
      return createVNode("div", {
        ...
        default: () => {
          var _a, _b;
          return [(_b = (_a = slots.day) == null ? void 0 : _a.call(slots, slotProps)) != null ? _b : createVNode(VBtn, slotProps.props, null)];
        }
      })]);
    })])]);
  }
...
const VDatePickerMonths = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode("div", {
      ...
      return (_b = (_a = slots.month) == null ? void 0 : _a.call(slots, {
        month,
        i,
        props: btnProps
...
const VDatePickerYears = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode("div", {
      ...
      return (_b = (_a = slots.year) == null ? void 0 : _a.call(slots, {
        year,
        i,
        props: btnProps
      })) != null ? _b : createVNode(VBtn, mergeProps({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode(VPicker, mergeProps(pickerProps, {
        ...
        title: () => {
          var _a2, _b2;
          return (_b2 = (_a2 = slots.title) == null ? void 0 : _a2.call(slots)) != null ? _b2 : createVNode("div", {
    ...
    default: withCtx(() => [
      ...
      createVNode(VCard, {
        ...
        default: withCtx(() => [
          createVNode(VCardText, null, {
            default: withCtx(() => [
              createTextVNode(" Edit pool lists buckets and access keys. You can add/delete buckets. A bucket name should be unique in all pools including ones owned by others. ")
            ]),
            _: 1
          })
        ]),
          ...
          createVNode(VCard, { class: "w-75 pa-4 ma-4" }, {
            default: withCtx(() => [
              ...
              createVNode(VBtn, {
                ...
                onClick: _cache[2] || (_cache[2] = ($event) => $options.kick_make_secret("readwrite"))
              }, {
                default: withCtx(() => [
              ...
              createVNode(VBtn, {
                "prepend-icon": "mdi-key-plus",
                onClick: _cache[3] || (_cache[3] = ($event) => $options.kick_make_secret("readonly"))
              }, {
                default: withCtx(() => [
              ...
              createVNode(VBtn, {
                "prepend-icon": "mdi-key-plus",
                onClick: _cache[4] || (_cache[4] = ($event) => $options.kick_make_secret("writeonly"))
              }, {
                default: withCtx(() => [
              ...
              createVNode(VRow, { justify: "center" }, {
                default: withCtx(() => [
                  createVNode(VDatePicker, {
                    ...
                    "hide-actions": true,
                    "input-mode": "keyboard",
                    min: new Date(Date.now() - 24 * 3600 * 1e3),
                    modelValue: $props.pool_data.key_expiration_time,
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $props.pool_data.key_expiration_time = $event),
                    landscape: true,
                    elevation: "0"
...
const pool_data_ = {
  ...
  api_make_bucket(pool, name, policy) {
  ...
  api_make_secret(pool, rw) {
    ...
    const tv0 = pool_data.key_expiration_time.getTime() / 1e3;
    const tzfix = pool_data.key_expiration_time.getTimezoneOffset() * 60;
    const expiration = Math.floor(tv0 - tzfix);
    const method = "POST";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(VFooter, { class: "bg-grey-lighten-1" }, {
    default: withCtx(() => [
      createVNode(VSpacer),
      createBaseVNode("div", _hoisted_1, toDisplayString($props.pool_data.footer_banner), 1),
      createVNode(VSpacer)
    ]),
    _: 1
  });
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(VApp, null, {
        default: withCtx(() => [
          createVNode(DefaultBar, { pool_data: unref(pool_data) }, null, 8, ["pool_data"]),
          ...
          createVNode(DefaultFooter, { pool_data: unref(pool_data) }, null, 8, ["pool_data"])
        ]),
        _: 1
      });
    };
